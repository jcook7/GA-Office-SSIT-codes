...
for iExp = 1:A.ssaOptions.Nexp
    B{1} = B{1}.loadData('ToggleSSAData50Expts.csv',{'x1',['exp',num2str(iExp),'_s1'];'x2',['exp',num2str(iExp),'_s2']}); % Link non-distorted data.
    B{2} = B{2}.loadData('ToggleSSAData50Expts.csv',{'x1',['exp',num2str(iExp),'_s1_Distorted'];'x2',['exp',num2str(iExp),'_s2_Distorted']}); % Link non-distorted data.
    B{3} = B{3}.loadData('ToggleSSAData50Expts.csv',{'x1',['exp',num2str(iExp),'_s1_Distorted'];'x2',['exp',num2str(iExp),'_s2_Distorted']}); % Link non-distorted data.
    for m=1:3
