...
%   comp_Model = load('simple_dusp1_model.mat').simple_Model;
    %% 
  starttime=-15000
  ...
  comp_Modelssa.ssaOptions.Nexp = 25; 
...
for iExp = 1:comp_Modelssa.ssaOptions.Nexp
    ...
    B = comp_Model.loadData('CompDuspSSAData200Expts_B.csv',{'x1',['exp',num2str(iExp),'_s1'];'x2',['exp',num2str(iExp),'_s2'];'x3',['exp',num2str(iExp),'_s3']}); % Link non-distorted data.
    %B = comp_Model.loadData('CompDuspSSAData200Expts_B.csv',{'x1',['exp',num2str(iExp),'_s1'];'x2',['exp',num2str(iExp),'_s2']}); % Link non-distorted data.
    %B = comp_Model.loadData('CompDuspSSAData200Expts_B.csv',{'x2',['exp',num2str(iExp),'_s2']}); % Link non-distorted data.
